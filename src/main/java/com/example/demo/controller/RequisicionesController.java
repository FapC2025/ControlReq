...
public class RequisicionesController {
	...
	@Operation(summary ="Operacion responsable de la actualizacion del objeto completo")
	public Mono<Requisiciones> actualizarCompleto(@PathVariable String id, @RequestBody  Requisiciones req){
		return requisicionesService.actualizarRequisicionCompleta(id, req);
	}
}
